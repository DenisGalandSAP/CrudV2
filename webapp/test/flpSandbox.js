		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CRUD App",
									"targetURL": "#nmcbeproject5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nmcbeproject5-display": {
								"semanticObject": "nmcbeproject5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nmc.be.project5",
									"url": sap.ui.require.toUrl("nmc/be/project5")
								}
							}
						}
					}
